...
# Activer l'intent `message_content` uniquement si le bot doit lire le contenu brut
# des messages (les commandes basées sur un préfixe en ont généralement besoin).
# Ajustez selon les besoins du bot et activez l'intent correspondant dans le
# portail des développeurs Discord si nécessaire.
